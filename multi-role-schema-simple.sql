-- =====================================================
-- Multi-Role Administration Panel - SIMPLIFIED Schema
-- =====================================================
-- This schema focuses on core functionality without complex RLS
-- =====================================================
...
-- Simple policies - allow all for now (can be tightened later)
CREATE POLICY "Allow all for organizations" ON organizations FOR ALL USING (true);
CREATE POLICY "Allow all for user_roles" ON user_roles FOR ALL USING (true);
CREATE POLICY "Allow all for permissions" ON permissions FOR ALL USING (true);
CREATE POLICY "Allow all for api_access_control" ON api_access_control FOR ALL USING (true);
CREATE POLICY "Allow all for user_invitations" ON user_invitations FOR ALL USING (true);
...
BEGIN
    ...
    RAISE NOTICE 'RLS policies enabled for all tables (simplified for now)';
