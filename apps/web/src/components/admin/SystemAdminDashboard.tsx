      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <Link href="/admin/organizations" className="font-medium text-blue-600 hover:text-blue-500 flex items-center justify-between">
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <Link href="/admin/users" className="font-medium text-green-600 hover:text-green-500">
                  View all users
                </Link>
              </div>
            </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg">
            ...
            <div className="bg-gray-50 px-5 py-3">
              <div className="text-sm">
                <Link href="/admin/apis" className="font-medium text-purple-600 hover:text-purple-500">
                  Manage APIs
                </Link>
              </div>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            <Link
              ...
              className="bg-white overflow-hidden shadow rounded-lg hover:shadow-md transition-shadow border-l-4 border-blue-500"
            >
              <div className="p-5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">View Organizations</h3>
