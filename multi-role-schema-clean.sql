-- =====================================================
-- Multi-Role Administration Panel - CLEAN Schema
-- =====================================================
-- This schema creates new tables with NO RLS policies to avoid conflicts
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE 'NO RLS policies applied (clean implementation)';
