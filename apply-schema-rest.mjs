...
/**
 * Apply database schema using Supabase REST API
 * This script executes the SQL schema directly through the Supabase REST API
 */
...
async function applySchema() {
  console.log('🚀 Applying Multi-Role Database Schema via REST API')
  console.log('===================================================')
...
async function verifySchema() {
  ...
  try {
    ...
    const permResponse = await fetch(`${supabaseUrl}/rest/v1/permissions?select=count`, {
      headers: {
        'Authorization': `Bearer ${supabaseAnonKey}`,
        'apikey': supabaseAnonKey
      }
...
async function main() {
  console.log('🔧 Multi-Role Database Schema Setup via REST API')
  console.log('==================================================')
