-- =====================================================
-- Fix Schema Issues - Missing Columns and Runtime Errors
-- =====================================================
-- This migration fixes the missing columns and schema issues
-- =====================================================

-- Add missing is_active column to organizations table
...
-- Update the organizations table to ensure proper structure
...
-- Note: System admin user will be created through the application

-- Fix the infinite recursion issue by updating RLS policies
...
-- Create fixed RLS policies for user_roles
...
BEGIN
    ...
    RAISE NOTICE 'Added missing columns: is_active to organizations, profiles';
    RAISE NOTICE 'Fixed RLS policies to prevent infinite recursion';
    RAISE NOTICE 'Created helper functions and system admin user';
